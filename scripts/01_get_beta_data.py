...
edges = gpd.read_file(homepath + "/data/raw/folkersma_digital/2023-08-01 Cycling network Denmark shapefiles/stretch.shp")
...
edges_study["myattribute"] = edges_study.apply(
    lambda x: int(x.myattribute), axis = 1)
# do we need this?

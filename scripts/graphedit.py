...
def spatialgraph_tojson(G, my_crs, filepath):
    ...
    # add crs from string
    node_link_data["graph"] = {} # step needed to delete the "crs type" object from here and overwrite it with a str object
...
### convert a geodataframe of linestrings into a networx graph
